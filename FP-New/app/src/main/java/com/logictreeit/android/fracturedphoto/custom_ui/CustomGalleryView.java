 ...
 */
public class CustomGalleryView extends AdapterView<ListAdapter> implements
        ViewTreeObserver.OnTouchModeChangeListener {
    private static final String LOGTAG = "CustomGalleryView";
    ...
    public interface OnScrollListener {
         ...
         */
        public void onScrollStateChanged(CustomGalleryView view, int scrollState);
         ...
         */
        public void onScroll(CustomGalleryView view, int firstVisibleItem, int visibleItemCount,
                             int totalItemCount);
    }

    /**
     * A RecyclerListener is used to receive a notification whenever a View is placed
     * inside the RecycleBin's scrap heap. This mListener is used to free resources
     * associated to Views placed in the RecycleBin.
     *
     * @see RecycleBin
     * @see CustomGalleryView#setRecyclerListener(RecyclerListener)
     */
    ...
    /**
     * Set the mListener that will receive notifications every time the list scrolls.
     *
    ...
    /**
     * Sets the recycler mListener to be notified whenever a View is set aside in
     * the recycler for later reuse. This mListener can be used to free resources
     * associated to the View.
     *
     * @param listener The recycler mListener to be notified of views set aside
     *                 in the recycler.
     * @see RecycleBin
     ...
     * choice mode has not been set to {@link #CHOICE_MODE_NONE} and the mAdapter
    ...
    public boolean showContextMenuForChild(View originalView) {
        ...
        if (longPressPosition >= 0) {
            ...
            if (listener != null) {
                handled = listener.onItemLongClick(CustomGalleryView.this, originalView, longPressPosition, longPressId);
            }
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(CustomGalleryView.class.getName());
    }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        ...
        info.setClassName(CustomGalleryView.class.getName());
    ...
    /**
     * Notify our scroll mListener (if there is one) of a change in scroll state
     */
     ...
     *                                     the last available child from the mAdapter.
    ...
    private boolean performLongPress(final View child,
        ...
        OnItemLongClickListener listener = getOnItemLongClickListener();
        if (listener != null) {
            handled = listener.onItemLongClick(CustomGalleryView.this, child,
                    longPressPosition, longPressId);
        }

        if (!handled) {
            mContextMenuInfo = createContextMenuInfo(child, longPressPosition, longPressId);
            handled = super.showContextMenuForChild(CustomGalleryView.this);
        }
    ...
    public static class LayoutParams extends ViewGroup.LayoutParams {
        /**
         * Type of this view as reported by the mAdapter
         */
        int viewType;
    ...
    private class AdapterDataSetObserver extends DataSetObserver {
        ...
        public void onChanged() {
            ...
            if (CustomGalleryView.this.mHasStableIds && mInstanceState != null
                    && mOldItemCount == 0 && mItemCount > 0) {
                CustomGalleryView.this.onRestoreInstanceState(mInstanceState);
                mInstanceState = null;
            } else {
                rememberSyncState();
            }
        ...
        public void onInvalidated() {
            ...
            if (CustomGalleryView.this.mHasStableIds) {
                // Remember the current state for the case where our hosting mActivity is being
                // stopped and later restarted
                mInstanceState = CustomGalleryView.this.onSaveInstanceState();
            }
    ...
    static class SavedState extends BaseSavedState {
        ...
        /**
         * Constructor called from {@link CustomGalleryView#onSaveInstanceState()}
         */
    ...
    private static class ArrowScrollFocusResult {
        ...
        /**
         * How {@link CustomGalleryView#arrowScrollFocused} returns its values.
         */
