...
public class ShatteredPuzzleLandingActivity extends Activity implements ApplicationConstants {

    private EditText editText;
    LinearLayout ll;
    View mView;
    public RelativeLayout relativeLayout;
    //public TextView inappBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.shattered_puzzle_landing_screen);
        editText = (EditText) findViewById(R.id.pzlNameInput);
        Utils.applyFontForWholeView(getApplicationContext(), (LinearLayout) findViewById(R.id.shatteredPuzzleLandingScreen), "Bold");

        ll = (LinearLayout) findViewById(R.id.shatteredPuzzleLandingScreen);
    ...
    public void startClicked(View v) {
        ...
        if (pzlName.length() < 1) {
            ...
            intent.putExtra(Extras_Keys.PHOTO_PATH, getIntent().getStringExtra(Extras_Keys.PHOTO_PATH));
            ...
            intent.putExtra(Extras_Keys.PHOTO_URI, getIntent().getStringExtra(Extras_Keys.PHOTO_URI));
            intent.putExtra(Extras_Keys.IS_CREATE_PUZZLE_MODE, getIntent().getBooleanExtra(Extras_Keys.IS_CREATE_PUZZLE_MODE, true));
	...
	/*@Override
	public void displayInappPurches() {
		// TODO Auto-generated method stub
		super.displayInappPurches();
	}*/
    ...
    private void showToast(final String msg) {
        runOnUiThread(() -> Toast.makeText(ShatteredPuzzleLandingActivity.this, msg, Toast.LENGTH_LONG).show());
    }
}
