...
//        });
//
//        // Query purchases incase a user is connecting from a different device
//        // and they've already purchased the app
//        queryPurchases();
//        queryPrefPurchases();
//
//    }
...
//        // but can be used if purchases ever need to be queried in the future
